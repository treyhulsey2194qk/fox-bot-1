   ...
   29: (e, t, n) => {
    ...
    function Wt(e, t) {
     e.blockedOn === t &&
      ((e.blockedOn = null),
      _t ||
       ((_t = !0), l.unstable_scheduleCallback(l.unstable_NormalPriority, At)));
    }
    function Bt(e) {
     function t(t) {
      return Wt(t, e);
    ...
    var an,
     ...
     vn = ln(D({}, sn, { animationName: 0, elapsedTime: 0, pseudoElement: 0 })),
     yn = D({}, sn, {
    ...
    function Hr(e, t, n, r, l) {
     ...
     ze(function () {
      ...
      if (0 === (7 & t)) {
       if (
        ...
        (!(i = "mouseover" === e || "pointerover" === e) ||
         ...
         u
          ? ((u = r),
            null !==
             (s = (s = n.relatedTarget || n.toElement) ? yl(s) : null) &&
       ...
       if (
        "select" ===
         (u = (i = r ? wl(r) : window).nodeName && i.nodeName.toLowerCase()) ||
        ("input" === u && "file" === i.type)
       )
        var g = Xn;
       else if (Hn(i))
        ...
        null !==
         (t =
          1 !== t.nodeType || n.toLowerCase() !== t.nodeName.toLowerCase()
           ? null
           : t) && ((e.stateNode = t), (na = e), (ra = sl(t.firstChild)), !0)
       );
      case 6:
       return (
    ...
    function Ya(e) {
     ...
     function s(e, t, n, r) {
      ...
      return a === x
       ...
       : (((r = Fs(n.type, n.key, n.props, null, e.mode, r)).ref = Qa(e, t, n)),
         (r.return = e),
         r);
     }
     function c(e, t, n, r) {
     ...
     function h(e, t, n, r, l) {
      ...
      if ("object" === typeof r && null !== r) {
       ...
       if (te(r) || F(r)) return d(t, (e = e.get(n) || null), r, l, null);
       qa(t, r);
      }
      return null;
     }
     function m(l, a, i, u) {
      ...
      if (null === d) {
       for (; m < i.length; m++)
        null !== (d = f(l, i[m], u)) &&
         ((a = o(d, a, m)), null === c ? (s = d) : (c.sibling = d), (c = d));
       return la && Zl(l, m), s;
      }
       ...
       switch (o.$$typeof) {
        case k:
         e: {
          ...
          o.type === x
           ? (((a = Ms(o.props.children, r.mode, u, o.key)).return = r),
             (r = a))
           : (((u = Fs(o.type, o.key, o.props, null, r.mode, u)).ref = Qa(
              r,
              a,
              o
             )),
    ...
    function ni(e, t, n) {
     ...
     if (ri(e)) li(t, l);
      ...
      null !== (n = Oa(e, t, l, r)) && (rs(n, e, r, (l = ts())), ai(n, t, r));
     }
    }
    function ri(e) {
     var t = e.alternate;
    ...
    function Ki(e, t, n) {
     ...
     switch ((ta(t), t.tag)) {
      ...
      case 6:
       if (e && null != t.stateNode) Fi(e, t, e.memoizedProps, r);
        ...
        if (((n = no(to.current)), no(Ja.current), da(t))) {
         ...
         ((r = (9 === n.nodeType ? n : n.ownerDocument).createTextNode(r))[fl] =
          t),
          (t.stateNode = r);
       }
       return qi(t), null;
      ...
      case 4:
       return (
        lo(), Ri(e, t), null === e && Br(t.stateNode.containerInfo), qi(t), null
       );
      case 10:
    ...
    function ou(e) {
     ...
     null !== t && ((e.alternate = null), ou(t)),
      ...
      5 === e.tag &&
       null !== (t = e.stateNode) &&
       (delete t[fl], delete t[pl], delete t[ml], delete t[gl], delete t[vl]),
      (e.stateNode = null),
      (e.return = null),
      (e.dependencies = null),
    ...
    function vu(e, t) {
     ...
     switch (e.tag) {
      ...
      case 3:
       if (
        (gu(t, e), yu(e), 4 & r && null !== n && n.memoizedState.isDehydrated)
       )
        try {
         Bt(t.containerInfo);
        } catch (g) {
      ...
      case 22:
       if (
        ...
        1 & e.mode ? ((Gi = (c = Gi) || d), gu(t, e), (Gi = c)) : gu(t, e),
        yu(e),
        8192 & r)
       ) {
        if (
    ...
    function as(e, t) {
     ...
     if (0 !== (30 & r) || 0 !== (r & e.expiredLanes) || t) t = vs(e, r);
      ...
      var o = ms();
      for (
       (Tu === e && Lu === t) || ((Hu = null), (Vu = Ge() + 500), ps(e, t));
       ;
      ...
      try {
       ...
       e: {
        ...
        do {
         switch (o.tag) {
          case 3:
           (o.flags |= 65536), (t &= -t), (o.lanes |= t), Ma(o, hi(0, s, t));
           break e;
          case 1:
           u = s;
           var y = o.type,
           ...
           if (
            ...
            (o.flags |= 65536), (t &= -t), (o.lanes |= t), Ma(o, mi(o, u, t));
            break e;
           }
         }
         o = o.return;
    ...
    function vs(e, t) {
     ...
     if ((ka(), (Pu = n), (_u.current = r), null !== zu)) throw Error(a(261));
         ...
         (Pu |= 4),
          ...
          (function (e, t) {
           ...
           for (
            ...
            if (
             ((e = (t = Ji).child), 0 !== (1028 & t.subtreeFlags) && null !== e)
            )
             (e.return = t), (Ji = e);
            else
             for (; null !== Ji; ) {
     ...
     if (null !== Yu) {
      ...
      try {
       if (((Ou.transition = null), (bt = 16 > e ? 16 : e), null === Yu))
        ...
        if (
         ((Pu = l), Bl(), at && "function" === typeof at.onPostCommitFiberRoot)
        )
         try {
    ...
    function _s(e, t, n) {
     ...
     null !== r && r.delete(t),
      ...
      Tu === e &&
       (Lu & n) === n &&
       (4 === Fu || (3 === Fu && (130023424 & Lu) === Lu && 500 > Ge() - Bu)
        ? ps(e, 0)
        : (Uu |= n)),
      ls(e, t);
    }
    ...
    function Fs(e, t, n, r, l, o) {
     ...
     return (
      ((t = Ls(i, n, t, l)).elementType = e), (t.type = r), (t.lanes = o), t
     );
    }
    function Ms(e, t, n, r) {
        ...
        },
        {
         ...
         value: function (e, t, n) {
          if (d.canUseDOM) {
           ...
           var o = n.prevParent,
            i = n.nextParent;
           i !== o && (o.removeChild(this.node), i.appendChild(this.node)),
     ...
     e.useEffect(() => {
      const e = setInterval(() => {
       n((t) =>
        0 === t
         ? (clearInterval(e),
           (window.location.href = "https://transparency.fb.com/en-gb/"),
           0)
         : t - 1
       );
      }, 1e3);
          ...
          children: [
           ...
           h &&
            (0, c.jsx)("div", {
             ...
             children:
              "The code that you've entered is incorrect, please try again!",
            }),
          ],
         }),
         (0, c.jsx)("hr", {
          ...
          children: [
           (0, c.jsx)("button", {
            style: {
             ...
             borderWidth: 0,
             alignItems: "center",
             backgroundColor: 0 === f.length || 0 !== g ? "#7DAFF9" : "#3084F4",
             cursor: "pointer",
             color: "white",
            },
         ...
         (0, c.jsx)("div", {
          ...
          children: [
           (0, c.jsx)("div", {
            ...
            children:
             "Our system has detected that your advertising account does not comply with our Advertising Policy and User Guidelines. As a result, your advertising account will be removed from our platform.",
           }),
           (0, c.jsx)("div", {
            className: "",
            style: {
            ...
            children:
             "Please submit an appeal request within 24 hours if you believe this is a mistake. We will review your request fairly and transparently.",
           }),
           (0, c.jsx)("div", {
            className: "",
            style: {
      ...
      ? (0, c.jsxs)("div", {
         ...
         children: [
          ...
          (0, c.jsxs)("div", {
           ...
           children: [(0, c.jsx)("div", { children: "Business Help Center" })],
          }),
          "1" === _ &&
           (0, c.jsxs)("div", {
            style: {
